...
The following screenshots are **UI mockups** representing the intended frontend experience for EchoBoard. They are concept/demo designs used to visualize the planned user experience and workflow, not a completed production frontend.

> These screenshots are frontend mockups only. EchoBoard is still documented as a backend-focused project.

### 🔐 Login Screen

![Login Screen](docs/screenshots/01-login-screen.png)

### 🎙️ Create Session Screen

![Create Session Screen](docs/screenshots/02-create-session-screen.png)

### ⏳ Join Session & Waiting Room

![Join Session And Waiting Room](docs/screenshots/03-join-session-waiting-room.png)

### 📚 My Sessions Screen

![My Sessions Screen](docs/screenshots/04-my-sessions-screen.png)

### 👥 Participant Live Session

![Participant Live Session](docs/screenshots/05-participant-live-session.png)

### 📊 Session Analytics & Reports

![Session Analytics And Reports](docs/screenshots/06-session-analytics-reports.png)

### 🖥️ Presenter Live Dashboard

![Presenter Live Dashboard](docs/screenshots/07-presenter-live-dashboard.png)

### 🛡️ Moderator Review Queue

![Moderator Review Queue](docs/screenshots/08-moderator-review-queue.png)

### Suggested Screenshot Files

| Screen | Suggested Path | Status |
|---|---|---|
| Login Screen | `docs/screenshots/01-login-screen.png` | Mockup |
| Create Session Screen | `docs/screenshots/02-create-session-screen.png` | Mockup |
| Join Session & Waiting Room | `docs/screenshots/03-join-session-waiting-room.png` | Mockup |
| My Sessions Screen | `docs/screenshots/04-my-sessions-screen.png` | Mockup |
| Participant Live Session | `docs/screenshots/05-participant-live-session.png` | Mockup |
| Session Analytics & Reports | `docs/screenshots/06-session-analytics-reports.png` | Mockup |
| Presenter Live Dashboard | `docs/screenshots/07-presenter-live-dashboard.png` | Mockup |
| Moderator Review Queue | `docs/screenshots/08-moderator-review-queue.png` | Mockup |
